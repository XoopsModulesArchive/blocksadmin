<?php
// $Id: admin.php,v 1.2 2005/08/18 12:19:39 jkp Exp $
...
define("_AM_EDITABLEBYGROUPS", "Editable by groups");
define("_BADMIN_AM_INSTANCES", "Block Instances");
define("_BADMIN_AM_ADDNEWBLOCK", "Create new block");
define("_BADMIN_AM_FILTERBYMODULE", "Filter by module");
define("_BADMIN_AM_ALLMODULES", "--All Modules");
?>